...
function Customer({persona:p,phase}){
 ...
 const prepared=Boolean(bridge.config)&&['prepared','ended','bound'].includes(binding.state);
 ...
 {presenter&&<aside className="launch-note"><strong>Presenter preparation</strong><p>Use the authenticated presenter launcher for every persona. It connects the actual conversation to the server-approved customer and current scenario; a persona link alone grants no record access.</p><p>Keep scenario selection in Salesforce. Never use this URL as proof of identity.</p></aside>}
 </main></>;
}
function App(){
